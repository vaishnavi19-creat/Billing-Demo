...
class CVendorRouter extends CBaseRouter {
    ...
    postRoutes() {
        ...
        // this.router.post('/vendor', VendorValidator.validateVendor(), this.vendorController.addVendor.bind(this.vendorController)); // Add new vendor
    ...
    deleteRoutes() {
        ...
        // this.router.delete('/vendor/:id', VendorValidator.validateVendorIdForSoftDelete(), VendorController.deleteVendor); // Soft delete vendor by ID
    }
}
