...
export class VendorValidator {
    ...
    // Validation method for updating vendor details
    static validateUpdateVendor() {
        console.log('Validating update vendor request...');
        return [
    ...
    static validateVendorIdForSoftDelete() {
        return [
            param('id', 'Invalid vendor ID for deletion.')
                .isInt()
...
// export class VendorValidator {
//     static validateGetAllVendor(): import("express-serve-static-core").RequestHandler<{}, any, any, import("qs").ParsedQs, Record<string, any>> {
//         throw new Error("Method not implemented.");
//     }
//     // Validate vendor ID as a parameter
//     static validateVendorId() {
//         return [
//             param('id', 'Invalid vendor ID.')
//                 .isInt()
