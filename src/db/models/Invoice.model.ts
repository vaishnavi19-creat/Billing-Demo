...
// import { InvoiceEntities } from "../entities/Invoice.entities";
// import AppDataSource from "../dataSource";
// import { createInvoiceReq, createInvoiceResp } from "../../interfaces/Invoice.interface";
...
//     public async createInvoice(invoiceData: createInvoiceReq): Promise<createInvoiceResp> {
//         try {
//             console.log('Jumped in InvoiceModel => createInvoice()');
...
//             };
//         } catch (error) {
//             throw new Error(`Error in createInvoice: ${error}`);
//         }
//     }

//     public async getAllInvoices(): Promise<any[]> {
//         try {
//             console.log('Jumped in InvoiceModel => getAllInvoices()');
//             return await this.repository.find({ relations: ["shop"] });
//         } catch (error) {
//             throw new Error(`Error in getAllInvoices: ${error}`);
//         }
//     }
// }
